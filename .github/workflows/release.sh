...
curl -L -X POST -H "Accept: application/vnd.github+json" -H "Authorization: Bearer $1" -H "Content-Type: application/octet-stream" --data-binary @"./all-llama-proxy/all-llama-proxy" "https://uploads.github.com/repos/netzbegruenung/all-llama-proxy/releases/$RELEASE_ID/assets?name=all-lama-proxy"
echo "Finished: $?"
